...
5. Currently only one hook can be registered per class. If we try to assign another hook then JSF will simple remove previous assigned hook for the class and add the new one.
